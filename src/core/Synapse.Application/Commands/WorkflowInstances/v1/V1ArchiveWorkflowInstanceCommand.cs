...
namespace Synapse.Application.Commands.WorkflowInstances
{
        ...
        ICommandHandler<V1ArchiveWorkflowInstanceCommand, Stream>
    {
        ...
        public V1ArchiveWorkflowInstanceCommandHandler(IServiceProvider serviceProvider, ILoggerFactory loggerFactory, IMediator mediator, IMapper mapper, IOptions<ApplicationOptions> options, 
